      ...
      <div className="flex flex-col ">
        <div className="bg-white p-0 rounded-lg shadow-md mt-2">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="user" id="u" className="text-xl block font-bold text-center">
                Datos del Usuario
              </label>
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  {users.filter((user) => !user.blocked).map((user) => (
            ...
            <div className="flex justify-center items-center h-20">
              <button onClick={assignRutina} className="botonAR">
